...
- Lime application rates are highly texture-dependent: sandy soils need ~50 lbs/1,000 sqft per pH unit; clay soils typically need 100–150 lbs/1,000 sqft per pH unit. Always recommend a soil test with buffer pH (Adams-Evans or Mehlich buffer) for the most precise rate. WITHOUT buffer pH data, you CAN still recommend a conservative starting rate: 40–50 lbs/1,000 sqft for sandy/loam soils, or 50–75 lbs/1,000 sqft for clay soils, and note that a follow-up soil test in 6 months will confirm whether a second application is needed. Being actionable is important — do not refuse to recommend a lime rate simply because buffer pH is unknown
