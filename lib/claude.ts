...
- LONG-TERM correction: elemental sulfur program (1–2 lbs/1,000 sq ft every 4–6 weeks) PLUS transition to acidifying nitrogen source (ammonium sulfate 21-0-0 provides both nitrogen and acidification, vs urea or nitrate-N which don't acidify). CRITICAL: Ammonium sulfate (21-0-0) is a FAST-ACTING, water-soluble, quick-release nitrogen source — do NOT describe it as "slow-release." Its advantage in high-pH soils is the acidifying effect of the ammonium form and sulfate content, not any slow-release property.
