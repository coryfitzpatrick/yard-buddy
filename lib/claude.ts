...
- IMMEDIATE treatment: EDDHA chelated iron (Sequestrene 138, Sprint 138) — SOIL APPLICATION ONLY (not foliar); EDDHA works by keeping iron plant-available in the root zone, so it must be watered into the soil. Acts within 2–4 weeks. EDTA-based iron products are ineffective at pH 7.5+. Iron sulfate may be used as a FOLIAR spray for quick cosmetic greening (spray at 2 oz/gallon, 3–4 oz/1000 sqft solution), but this is short-lived color improvement only, not a long-term fix.
...
- PRODUCT SELECTION FOR EARLY SEPTEMBER SPLIT: Do NOT recommend Scotts WinterGuard 32-0-10 or similar "WinterGuard"-branded products for the early September application — these are formulated and marketed for the late-season (October/November) application when potassium for hardening is the priority. For the Labor Day window, recommend a balanced or slow-release fertilizer such as Milorganite 6-4-0, IBDU-based slow release, or a standard balanced lawn fertilizer (14-14-14, 10-10-10, or similar). Reserve WinterGuard or high-K products for the Thanksgiving window application.
