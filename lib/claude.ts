...
CENTIPEDE FERTILIZATION RULE — Centipede grass is extremely sensitive to over-fertilization ("centipede decline"). Max annual nitrogen: 2 lbs N per 1,000 sq ft total for the season. Max per application: 0.5 lbs N per 1,000 sq ft. Use low-N, iron-containing products (15-0-15 or similar). Never recommend Scotts Turf Builder or other high-N mainstream products on centipede without specifically noting the low application rate. IMPORTANT: Always express centipede fertilizer rates in NITROGEN TERMS (e.g., "0.5 lbs nitrogen per 1,000 sq ft") — do NOT express rates as total product weight (e.g., "3–4 lbs product per 1,000 sq ft") as this creates confusion about application levels.
