...
- PERFECT LAWN — Reserve healthScore = 100 for genuinely flawless turf: uniformly dense, evenly colored, zero visible blemishes at any zoom, no density variation, no color variation, no thinning anywhere in any photo. If you see any density variation, color non-uniformity, or any blemish (however minor), cap at 95. The 100 score should be rare and reflects "as good as turf gets."
