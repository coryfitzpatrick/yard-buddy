    ...
    <footer className="border-t border-gray-200 bg-white mt-auto">
      <div className="max-w-6xl mx-auto px-6 py-6 pb-[calc(6rem+env(safe-area-inset-bottom))] sm:pb-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-legal text-gray-400">
        ...
        <div className="flex items-center gap-4">
          <Link prefetch={false} href="/contact" className="hover:text-gray-600 transition-colors">Contact</Link>
          <Link prefetch={false} href="/privacy" className="hover:text-gray-600 transition-colors">Privacy Policy</Link>
          <Link prefetch={false} href="/terms" className="hover:text-gray-600 transition-colors">Terms of Use</Link>
