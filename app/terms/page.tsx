      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-12 w-full">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>By creating an account or using Yard Analyzer, you agree to these Terms of Use. If you do not agree, please do not use the service.</p>
          </section>
          ...
          <section>
            ...
            <p>Recommendations provided by Yard Analyzer are generated by AI and are for informational purposes only. They do not constitute professional horticultural, agricultural, or landscaping advice. Always use your own judgment when applying products to your lawn. Yard Analyzer is not responsible for outcomes resulting from following AI-generated recommendations.</p>
          ...
          <section>
            ...
            <p>To the maximum extent permitted by law, Yard Analyzer and its operators shall not be liable for any indirect, incidental, or consequential damages arising from your use of the service. Our total liability for any claim shall not exceed the amount you paid us in the twelve months preceding the claim.</p>
          </section>
