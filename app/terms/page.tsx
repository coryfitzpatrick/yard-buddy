        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700 text-sm leading-relaxed">
          ...
          <section id="billing">
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li><strong>Upgrading from an annual plan to a higher plan&rsquo;s monthly</strong> (for example, Basic annual to Plus monthly) requires upgrading the remaining annual term to the higher plan&rsquo;s annual first. You are charged the prorated difference between the two annual prices today, the higher plan&rsquo;s features unlock immediately, and your annual term continues until your normal renewal date. On the renewal date, your billing switches to the higher plan&rsquo;s monthly. There is no way to get the higher plan on monthly billing today while still in a prepaid annual term &mdash; the higher plan must finish out the annual term first.</li>
              <li><strong>Downgrading from an annual plan to any lower plan</strong> (for example, Plus annual to Basic annual or Plus annual to Basic monthly) always waits for renewal. You keep using the plan you paid for through the full annual term. On the renewal date your plan switches to the new lower tier. We do not take features away or issue partial credits for time you already paid for.</li>
