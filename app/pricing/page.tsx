          ...
          <details className="rounded-xl border border-gray-200 bg-white p-5 group">
            ...
            <div className="mt-4 space-y-4 text-sm text-gray-600">
              ...
              <div>
                ...
                <p className="mt-1">If you&apos;re on annual, the only change that takes effect today is a tier upgrade. To get a higher plan on monthly billing, the remaining annual term has to upgrade to the higher plan&apos;s annual first &mdash; you pay the prorated difference, your features unlock now, your annual term finishes out, and on renewal you switch to monthly. Downgrades from annual always wait for renewal; you keep using what you paid for through the full term.</p>
              </div>
              <div>
